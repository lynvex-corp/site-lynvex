      ...
      <section className="pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-8">
                ...
                <div key={info.label} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {info.href ? (
                      ...
                      <p className="text-light text-sm font-medium">{info.value}</p>
                    )}
                  </div>
                </div>
              ))}
            ...
            {/* WhatsApp CTA */}
            <a
              href="https://wa.me/5500000000000?text=Olá! Gostaria de solicitar um orçamento para meu projeto."
              target="_blank"
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#25D366]/70">Resposta mais rápida</p>
              </div>
              <svg
